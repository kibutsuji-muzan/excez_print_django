...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='UUID')),
                ('salt', models.CharField(default='0567ee7b0a5996f31543037dfd8a04611952e9472bca8d02672fab', verbose_name='Salt')),
                ('nonce', models.CharField(default=74792, verbose_name='Nonce')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default='31075772eb0834f21756f72aed35bb', help_text='Hex-encoded secret key to generate totp tokens.', max_length=40, unique=True, validators=[django_otp.util.hex_validator], verbose_name='Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 7, 8, 4, 8, 913089, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 7, 8, 14, 8, 911828, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ceated At')),
