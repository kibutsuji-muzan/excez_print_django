...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='UUID')),
                ('salt', models.CharField(default='5d7bb3495916e061d3c5b4866355cfcffa45f8a5c19764dd4fe024', verbose_name='Salt')),
                ('nonce', models.CharField(default=20807, verbose_name='Nonce')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default='b05e69f21daf87077de92ac6', help_text='Hex-encoded secret key to generate totp tokens.', max_length=40, validators=[django_otp.util.hex_validator], verbose_name='Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 15, 16, 38, 51, 955237, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 15, 16, 48, 51, 954560, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ceated At')),
