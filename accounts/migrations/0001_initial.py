...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='UUID')),
                ('salt', models.CharField(default='859a4158330f4d549e5fe63b74b1f4fed7115d8bb5989903d6d6c1', verbose_name='Salt')),
                ('nonce', models.CharField(default=57866, verbose_name='Nonce')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default='efa274d136061ae7e3d2b3a7e21c20779b6cca', help_text='Hex-encoded secret key to generate totp tokens.', max_length=40, validators=[django_otp.util.hex_validator], verbose_name='Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 8, 18, 18, 54, 10, 573890, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 8, 18, 19, 4, 10, 572891, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ceated At')),
