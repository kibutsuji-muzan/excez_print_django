...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='UUID')),
                ('salt', models.CharField(default='fb5783b51c1f9d0de13ce00b7d1cd68e5a8153e1b53d1ad618e2e2', verbose_name='Salt')),
                ('nonce', models.CharField(default=77039, verbose_name='Nonce')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default='cbf78e3c48e36eb861dfd822102b3d905ea9eeae', help_text='Hex-encoded secret key to generate totp tokens.', max_length=40, unique=True, validators=[django_otp.util.hex_validator], verbose_name='Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 5, 9, 19, 32, 640603, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 7, 5, 9, 29, 32, 639287, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ceated At')),
