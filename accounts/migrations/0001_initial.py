...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='UUID')),
                ('salt', models.CharField(default='72b071a74ca785fd56c562e3c575416039ce05433b4f6acddf6364dc16', verbose_name='Salt')),
                ('nonce', models.CharField(default=31339, verbose_name='Nonce')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default='f37ea2014ddeda6ab54194e4', help_text='Hex-encoded secret key to generate totp tokens.', max_length=40, unique=True, validators=[django_otp.util.hex_validator], verbose_name='Secret Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 6, 26, 9, 55, 10, 814714, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2024, 6, 26, 10, 5, 10, 814033, tzinfo=datetime.timezone.utc), verbose_name='Expiry')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Ceated At')),
